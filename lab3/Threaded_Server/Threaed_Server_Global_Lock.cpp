...
#include "../Thread_Safe_KV_Store/ThreadSafeKVStore.h"
#include "../Thread_Safe_KV_Store/ThreadSafeKVStore.cpp"
#include "../md5/md5.h"
#include "../md5/md5.cpp"
...
//    Initialize the thread pool and launch all threads.
    ...
    ThreadSafeKVStore<std::string, int>* key_value_store = new ThreadSafeKVStore<std::string, int>();
    ThreadSafeKVStore<std::string, std::string>* md5_hash_store = new ThreadSafeKVStore<std::string, std::string>();
